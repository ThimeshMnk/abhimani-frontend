...
export default function Footer() {
  ...
  return (
    <footer
      id="site-footer"
      className="bg-[#141414] text-white pt-20 pb-12 border-t border-gray-800"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-10 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-gray-400 text-xs sm:text-sm leading-relaxed max-w-sm">
              {t(
                "footer_desc",
                "Sri Lanka's foremost survivor-led collective advocating for the rights, safety, bodily autonomy, and wellbeing of female and transgender sex workers.",
              )}
            </p>
